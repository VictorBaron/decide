...
This project is named Decide. It's a SaaS to help companies make decisions, and see the decisions log.

## Technical details

Decide is a pnpm monorepo with a NestJS API backend and React frontend.
