import {
  ...
  Criticality,
  DueDate,
} from "src/core/decision-proposals/domain";
import { DecisionProposalResponseDTO } from "src/core/decision-proposals/dto";
...
import { isBlock } from "src/core/decision-proposals/domain/entities/editor";
